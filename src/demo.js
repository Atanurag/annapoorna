...
<Header className='header'>
      <Row justify="space-between" align="middle" gutter={[16,16]} >
        <Col xs={18} sm={6} md={8} lg={12} style={{marginTop:'12px'}} >
        ...
        <Col  xs={6} sm={7} md={4} lg={4} style={{marginTop:'12px'}}>
        <div style={{border:'1px solid red',display:'flex',alignItems:'center',width:'90px',justifyContent:'space-between'}}>
...
<div style={{position:'relative'}}>
 ...
 }} xmlns="http://www.w3.org/2000/svg"  fill="none" style={{height:"24px",width:"24px",marginTop:'3px'}}viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
